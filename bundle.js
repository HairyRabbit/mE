...
/***/ function(module, exports, __webpack_require__) {
	...
	var Elm, Style, elm, path;

	Style = __webpack_require__(1);

	Elm = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./glob.styl", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./glob.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var require;var require;var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(global) {var Elm = Elm || { Native: {} };
	Elm.Native.Basics = {};
	...
	Elm.Maybe.make = function (_elm) {
	       ...
	       var map3 = F4(function (func,ma,mb,mc) {
	                     ...
	                     if (_p7.ctor === "_Tuple3" && _p7._0.ctor === "Just" &&
	                         _p7._1.ctor === "Just" && _p7._2.ctor === "Just") {
	       ...
	       var map4 = F5(function (func,ma,mb,mc,md) {
	                     ...
	                     if (_p8.ctor === "_Tuple4" && _p8._0.ctor === "Just" &&
	                         _p8._1.ctor === "Just" && _p8._2.ctor === "Just" && _p8._3.ctor
	                         === "Just") {
	       ...
	       var map5 = F6(function (func,ma,mb,mc,md,me) {
	                     ...
	                     if (_p9.ctor === "_Tuple5" && _p9._0.ctor === "Just" &&
	                         _p9._1.ctor === "Just" && _p9._2.ctor === "Just" && _p9._3.ctor
	                         === "Just" && _p9._4.ctor === "Just") {
	                        return Just(A5(func
	                                      ,_p9._0._0
	                                      ,_p9._1._0
	                                      ,_p9._2._0
	...
	Elm.List.make = function (_elm) {
	       ...
	       var drop = F2(function (n,list) {
	                     drop: while (true)    if (_U.cmp(n,0) < 1)    return list;
	                                           else {
	                                              var _p0 = list;
	                                              if (_p0.ctor === "[]") {
	                                                 return list;
	       ...
	       var length = function (xs) {
	          return A3(foldl,F2(function (_p3,i) { return i + 1;}),0,xs);
	       };
	       var sum = function (numbers) {
	          return A3(foldl,F2(function (x,y) { return x + y;}),0,numbers);
	       };
	       var product = function (numbers) {
	          return A3(foldl,F2(function (x,y) { return x * y;}),1,numbers);
	       };
	       ...
	       var repeatHelp = F3(function (result,n,value) {
	                           repeatHelp: while (true)    if (_U.cmp(n,0) < 1)
	                                                          return result; else {
	...
	Elm.Color.make = function (_elm) {
	       ...
	       var fmod = F2(function (f,n) {
	                     ...
	                     return $Basics.toFloat(A2($Basics._op["%"],integer,n)) + f -
	       ...
	       var rgbToHsl = F3(function (red,green,blue) {
	                         ...
	                         var saturation = _U.eq(lightness,0) ? 0 : c / (1 - $Basics.abs(2
	                                                                        * lightness - 1));
	                         ...
	                         var _p0 = _U.cmp(hue$,0) < 0 ? {ctor: "_Tuple3"
	                                                        ...
	                                                        ,_2: 0} : _U.cmp(hue$,1) < 0 ? {ctor: "_Tuple3"
	                                                                                       ...
	                                                                                       ,_2: 0} : _U.cmp(hue$,2) < 0 ? {ctor: "_Tuple3"
	                                                                                                                      ...
	                                                                                                                      ,_1: chroma
	                                                                                                                      ,_2: 0} : _U.cmp(hue$,3) < 0
	                                   ? {ctor: "_Tuple3",_0: 0,_1: chroma,_2: x} : _U.cmp(hue$,4) < 0
	                                   ? {ctor: "_Tuple3",_0: 0,_1: x,_2: chroma} : _U.cmp(hue$,5) < 0
	                                   ? {ctor: "_Tuple3",_0: x,_1: 0,_2: chroma} : _U.cmp(hue$,6) < 0
	                                   ? {ctor: "_Tuple3",_0: chroma,_1: 0,_2: x} : {ctor: "_Tuple3"
	                                                                                ,_0: 0
	                                                                                ,_1: 0
	                                                                                ,_2: 0};
	                         var r = _p0._0;
	       ...
	       var hsla = F4(function (hue,saturation,lightness,alpha) {
	                     return A4(HSLA
	                              ,hue - $Basics.turns($Basics.toFloat($Basics.floor(hue / (2 *
	                                                                                        $Basics.pi))))
	                              ,saturation
	                              ,lightness
	                              ,alpha);
	...
	Elm.Graphics.Collage.make = function (_elm) {
	       ...
	       $List = Elm.List.make(_elm),
	       $Native$Graphics$Collage =
	       Elm.Native.Graphics.Collage.make(_elm),
	       $Text = Elm.Text.make(_elm),
	...
	Elm.Combine.make = function (_elm) {
	       ...
	       var sequence = function (ps) {
	          var accumulate = F3(function (acc,ps,cx) {
	                              accumulate: while (true) {
	                                 ...
	                                 if (_p5.ctor === "[]") {
	                                    ...
	                                    if (_p6._0.ctor === "Ok") {
	                                       var _v6 = A2($List._op["::"],_p6._0._0,acc),
	                                       _v7 = _p5._1,
	                                       _v8 = _p6._1;
	                                       acc = _v6;
	                                       ps = _v7;
	          ...
	          return Parser(function (cx) {
	                 return A3(accumulate,_U.list([]),ps,cx);
	              });
	       };
	       ...
	       var andMap = F2(function (lp,rp) {
	                       return A2(andThen
	                                ,lp
	                                ,function (f) {
	                                   return A2(andThen,rp,function (x) { return succeed(f(x));});
	                                });
	                    });
	       var between = F3(function (lp,rp,p) {
	                        return A2(andMap
	                                 ,A2(andMap
	                                    ,A2(map
	                                       ,$Basics.flip(function (_p7) {
	                                          return $Basics.always($Basics.always(_p7));
	                                       })
	                                       ,lp)
	                                    ,p)
	                                 ,rp);
	       ...
	       var skip = function (p) {
	          return A2(andThen,p,$Basics.always(succeed({ctor: "_Tuple0"})));
	       };
	       var count = F2(function (n,p) {
	                      var accumulate = F2(function (x,acc) {
	                                          return _U.cmp(x,0) < 1 ? succeed($List.reverse(acc))
	                                              : A2(andThen
	                                                  ,p
	                                                  ,function (res) {
	       ...
	       var regex = function (pattern) {
	          var pattern$ = A2($String.startsWith,"^",pattern) ? pattern
	                         : A2($Basics._op["++"],"^",pattern);
	          return Parser(function (cx) {
	                 var _p8 = A3($Regex.find
	                             ,$Regex.AtMost(1)
	                             ,$Regex.regex(pattern$)
	                             ,cx.input);
	                              ...
	                              accumulate: while (true) {
	                                 ...
	                                 if (_p10.ctor === "Just") {
	                                    ...
	                                    if (pred(_p11)) {
	                                       ...
	                                       var _v11 = A2($Basics._op["++"],acc,c),
	                                       _v12 = _U.update(cx,{input: _p10._0._1,position: pos});
	                                       acc = _v11;
	                                       cx = _v12;
	                                       continue accumulate;
	                   ...
	                   return Parser(function (cx) {
	                          ...
	                          if (_p13._0.ctor === "Ok") {
	                             ...
	                             if (_p14._0.ctor === "Ok") {
	                                ...
	                                return {ctor: "_Tuple2"
	                                       ,_0: $Result.Err(A2($Basics._op["++"],_p13._0._0,_p14._0._0))
	                                       ,_1: cx};
	                             }
	                          }
	                       });
	       ...
	       var maybe = function (p) {
	          return Parser(function (cx) {
	                 ...
	                 if (_p15.ctor === "_Tuple2" && _p15._0.ctor === "Ok") {
	                    return {ctor: "_Tuple2"
	                           ,_0: $Result.Ok($Maybe.Just(_p15._0._0))
	                           ,_1: _p15._1};
	                 } else {
	          ...
	          var accumulate = F2(function (acc,cx) {
	                              accumulate: while (true) {
	                                 ...
	                                 if (_p16.ctor === "_Tuple2" && _p16._0.ctor === "Ok") {
	                                    var _p17 = _p16._1;
	                                    if (_U.eq(cx,_p17))    return {ctor: "_Tuple2"
	                                                                  ,_0: $List.reverse(acc)
	                                                                  ,_1: cx}; else {
	       ...
	       var many1 = function (p) {
	          return A2(andMap
	                   ,A2(map,F2(function (x,y) { return A2($List._op["::"],x,y);}),p)
	                   ,many(p));
	       };
	...
	Elm.Combine.Infix.make = function (_elm) {
	       ...
	       if (_elm.Combine.Infix.values)
	          return _elm.Combine.Infix.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       ...
	       _op["<$"] = function (res) {
	              return $Combine.map(function (_p1) {
	                     return res;
	                  });
	           };
	       _op["<*>"] = $Combine.andMap;
	...
	Elm.Combine.Char.make = function (_elm) {
	       ...
	       if (_elm.Combine.Char.values)
	          return _elm.Combine.Char.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	          ...
	          return $Combine.primitive(function (cx) {
	                 ...
	                 if (_p0.ctor === "Just") {
	                    ...
	                    return pred(_p1) ? {ctor: "_Tuple2"
	                                       ,_0: $Result.Ok(_p1)
	                                       ,_1: _U.update(cx,{input: _p0._0._1,position: cx.position + 1})}
	                        : {ctor: "_Tuple2",_0: $Result.Err(_U.list([message])),_1: cx};
	                 } else {
	                    return {ctor: "_Tuple2"
	...
	Elm.Route.make = function (_elm) {
	       ...
	       $String = Elm.String.make(_elm);
	       var _op = {};
	       var and = F2(function (lr,rr) {
	                    return {parser: A2($Combine$Infix._op["<*>"]
	                                      ,A2($Combine$Infix._op["<$>"]
	                                         ,F2(function (v0,v1) {
	                                            return {ctor: "_Tuple2",_0: v0,_1: v1};
	                                         })
	                                         ,A2($Combine$Infix._op["<*"],lr.parser,$Combine.string("/")))
	                                      ,rr.parser)
	                           ,components: A2($Basics._op["++"],lr.components,rr.components)};
	                 });
	       _op["</>"] = and;
	       var unrouter = function (r) { var _p0 = r;return _p0._0;};
	       var match = F2(function (r,path) {
	                      return function (_p1) {
	                             return $Result.toMaybe($Basics.fst(_p1));
	                          }(A2($Combine.parse,unrouter(r),path));
	                   });
	       var Router = function (a) { return {ctor: "Router",_0: a};};
	       var unroute = function (r) { var _p2 = r;return _p2._0;};
	       var router = function (rs) {
	          return Router($Combine.choice(A2($List.map
	                                          ,function (_p3) {
	                                             return function (_) {
	                                                    return _.parser;
	                                                 }(unroute(_p3));
	       ...
	       var reverse = F2(function (r,inputs) {
	                        var accumulate = F3(function (cs,is,xs) {
	                                            accumulate: while (true) {
	                                               var _p4 = {ctor: "_Tuple2",_0: is,_1: xs};
	                                               _v2_7: do {
	                                                  if (_p4.ctor === "_Tuple2") {
	                                                     if (_p4._1.ctor === "[]") {
	                                                        if (_p4._0.ctor === "[]") {
	                                                           return A2($Basics._op["++"]
	                                                                    ,"/"
	                                                                    ,A2($String.join,"/",$List.reverse(cs)));
	                                                        } else {
	                                                           break _v2_7;
	                                                        }
	                                                     } else {
	                                                        switch (_p4._1._0.ctor)
	                                                        {
	                                                          case "CPrefix":
	                                                            var _v3 = A2($List._op["::"],_p4._1._0._0,cs),
	                                                            _v4 = is,
	                                                            _v5 = _p4._1._1;
	                                                            cs = _v3;
	                                                            is = _v4;
	                                                            ...
	                                                            continue accumulate;
	                                                          case "CSuffix":
	                                                            var _v6 = A2($List._op["::"],_p4._1._0._0,cs),
	                                                            _v7 = is,
	                                                            _v8 = _p4._1._1;
	                                                            cs = _v6;
	                                                            is = _v7;
	                                                          ...
	                                                          case "CCustom":
	                                                            if (_p4._0.ctor === "::") {
	                                                               var _p7 = _p4._0._0;
	                                                               var _p5 = _p4._1._0._0(_p7);
	                                                               if (_p5.ctor === "Ok") {
	                                                                  var _v10 = A2($List._op["::"],_p7,cs),
	                                                                  _v11 = _p4._0._1,
	                                                                  _v12 = _p4._1._1;
	                                                                  cs = _v10;
	                                                                  is = _v11;
	                                                                  ...
	                                                                  return _U.crashCase("Route"
	                                                                                     ,{start: {line: 496,column: 11},end: {line: 501,column: 86}}
	                                                                                     ,_p5)(A2($Basics._op["++"]
	                                                                                             ,_p5._0
	                                                                                             ,A2($Basics._op["++"]
	                                                          ...
	                                                          case "CString":
	                                                            if (_p4._0.ctor === "::") {
	                                                               var _v13 = A2($List._op["::"],_p4._0._0,cs),
	                                                               _v14 = _p4._0._1,
	                                                               _v15 = _p4._1._1;
	                                                               cs = _v13;
	                                                               is = _v14;
	                                                          ...
	                                                          case "CInt":
	                                                            if (_p4._0.ctor === "::") {
	                                                               var _p9 = _p4._0._0;
	                                                               var _p8 = $String.toInt(_p9);
	                                                               if (_p8.ctor === "Ok") {
	                                                                  var _v17 = A2($List._op["::"],_p9,cs),
	                                                                  _v18 = _p4._0._1,
	                                                                  _v19 = _p4._1._1;
	                                                                  cs = _v17;
	                                                                  is = _v18;
	                                                                  ...
	                                                                  return A2($Basics._op["++"]
	                                                                           ,_U.crash("Route"
	                                                                                    ,{start: {line: 512,column: 15}
	                                                                                     ,end: {line: 512,column: 26}})(_p8._0)
	                                                          ...
	                                                          default:
	                                                            if (_p4._0.ctor === "::") {
	                                                               return A2($Basics._op["++"]
	                                                                        ,_U.crash("Route"
	                                                                                 ,{start: {line: 515,column: 11}
	                                                                                  ,end: {line: 515,column: 22}})(_p4._1._0._0)
	                                                                        ," in a call to \'reverse\'");
	                                                            } else {
	                                                               break _v2_7;
	                                                            }
	                                               ...
	                                               return _U.crashCase("Route"
	                                                                  ,{start: {line: 485,column: 7},end: {line: 518,column: 80}}
	                                                                  ,_p4)("\'reverse\' called with an unexpected number of arguments");
	                                            }
	                                         });
	                        return A3(accumulate
	                                 ,_U.list([])
	                                 ,inputs
	                                 ,function (_) {
	                                    return _.components;
	       ...
	       var Route = function (a) { return {ctor: "Route",_0: a};};
	       var route = F2(function (f,r) {
	                      return Route(_U.update(r
	                                            ,{parser: A2($Combine$Infix._op["<$>"]
	                                                        ,f
	                                                        ,A2($Combine$Infix._op["<*"]
	                                                           ,A2($Combine$Infix._op["*>"],$Combine.string("/"),r.parser)
	                                                           ,$Combine.end))}));
	                   });
	       _op[":="] = route;
	       var RouteComponent = F2(function (a,b) {
	                               return {parser: a,components: b};
	                            });
	       var CFail = function (a) { return {ctor: "CFail",_0: a};};
	       var child = F2(function (f,r) {
	                      return Route({parser: A2($Combine$Infix._op["<$>"]
	                                              ,f
	                                              ,unrouter(r))
	                                   ,components: _U.list([CFail("nested routers cannot be reverse-routed")])});
	                   });
	       var CInt = {ctor: "CInt"};
	       var $int = {parser: $Combine$Num.$int
	                  ,components: _U.list([CInt])};
	       var CString = {ctor: "CString"};
	       var string = {parser: $Combine.regex("[^/]+")
	                    ,components: _U.list([CString])};
	       var CCustom = function (a) { return {ctor: "CCustom",_0: a};};
	       var custom = function (p) {
	          var validator = function (s) {
	             var _p11 = A2($Combine.parse,p,s);
	             if (_p11._0.ctor === "Ok") {
	                return $Result.Ok({ctor: "_Tuple0"});
	             } else {
	                return $Result.Err(A2($String.join," or ",_p11._0._0));
	             }
	          };
	          return {parser: p,components: _U.list([CCustom(validator)])};
	       };
	       var CSuffix = function (a) { return {ctor: "CSuffix",_0: a};};
	       var suffix = F2(function (s,r) {
	                       return {parser: A2($Combine$Infix._op["<*"]
	                                         ,r.parser
	                                         ,$Combine.string(A2($Basics._op["++"],"/",s)))
	                              ,components: A2($Basics._op["++"]
	                                             ,r.components
	                                             ,_U.list([CSuffix(s)]))};
	                    });
	       _op["<>"] = $Basics.flip(suffix);
	       var CPrefix = function (a) { return {ctor: "CPrefix",_0: a};};
	       var prefix = F2(function (s,r) {
	                       return {parser: A2($Combine$Infix._op["*>"]
	                                         ,$Combine.string(A2($Basics._op["++"],s,"/"))
	                                         ,r.parser)
	                              ,components: A2($Basics._op["++"]
	...
	Elm.Dict.make = function (_elm) {
	       ...
	       var get = F2(function (targetKey,dict) {
	                    get: while (true) {
	                       ...
	                       if (_p4.ctor === "RBEmpty_elm_builtin") {
	                          ...
	                          {
	                            case "LT":
	                              var _v14 = targetKey,_v15 = _p4._3;
	                              targetKey = _v14;
	                              dict = _v15;
	                              continue get;
	                            case "EQ":
	                              return $Maybe.Just(_p4._2);
	                            default:
	                              var _v16 = targetKey,_v17 = _p4._4;
	                              targetKey = _v16;
	                              dict = _v17;
	                              continue get;
	                          }
	       ...
	       var ensureBlackRoot = function (dict) {
	          var _p10 = dict;
	          if (_p10.ctor === "RBNode_elm_builtin" && _p10._0.ctor ===
	              "Red") {
	             return A5(RBNode_elm_builtin
	                      ,Black
	                      ,_p10._1
	                                     ...
	                                     if (_p18._4.ctor === "RBNode_elm_builtin") {
	                                        switch (_p18._3._0.ctor)
	                                        {
	                                          case "Red":
	                                            ...
	                                            {
	                                              case "Red":
	                                                if (_p18._3._3.ctor === "RBNode_elm_builtin" &&
	                                                    _p18._3._3._0.ctor === "Red") {
	                                                   break _v31_0;
	                                                } else {
	                                                   if (_p18._3._4.ctor === "RBNode_elm_builtin" &&
	                                                       _p18._3._4._0.ctor === "Red") {
	                                                      break _v31_1;
	                                                   } else {
	                                                      if (_p18._4._3.ctor === "RBNode_elm_builtin" &&
	                                                          _p18._4._3._0.ctor === "Red") {
	                                                         break _v31_2;
	                                                      } else {
	                                                         if (_p18._4._4.ctor === "RBNode_elm_builtin" &&
	                                                             _p18._4._4._0.ctor === "Red") {
	                                                            break _v31_3;
	                                                         } else {
	                                                            break _v31_6;
	                                                         }
	                                              ...
	                                              case "NBlack":
	                                                if (_p18._3._3.ctor === "RBNode_elm_builtin" &&
	                                                   ...
	                                                   if (_p18._3._4.ctor === "RBNode_elm_builtin" &&
	                                                      ...
	                                                      if (_p18._0.ctor === "BBlack" && _p18._4._3.ctor ===
	                                                          "RBNode_elm_builtin" && _p18._4._3._0.ctor === "Black" &&
	                                                          _p18._4._4.ctor === "RBNode_elm_builtin" && _p18._4._4._0.ctor
	                                                          === "Black") {
	                                                         break _v31_4;
	                                                      } else {
	                                                         break _v31_6;
	                                          ...
	                                          case "NBlack":
	                                            switch (_p18._4._0.ctor)
	                                            {
	                                              case "Red":
	                                                if (_p18._4._3.ctor === "RBNode_elm_builtin" &&
	                                                   ...
	                                                   if (_p18._4._4.ctor === "RBNode_elm_builtin" &&
	                                                      ...
	                                                      if (_p18._0.ctor === "BBlack" && _p18._3._3.ctor ===
	                                                          "RBNode_elm_builtin" && _p18._3._3._0.ctor === "Black" &&
	                                                          _p18._3._4.ctor === "RBNode_elm_builtin" && _p18._3._4._0.ctor
	                                                          === "Black") {
	                                                         break _v31_5;
	                                                      } else {
	                                                         break _v31_6;
	                                              ...
	                                              case "NBlack":
	                                                if (_p18._0.ctor === "BBlack") {
	                                                   if (_p18._4._3.ctor === "RBNode_elm_builtin" &&
	                                                       _p18._4._3._0.ctor === "Black" && _p18._4._4.ctor ===
	                                                       "RBNode_elm_builtin" && _p18._4._4._0.ctor === "Black") {
	                                                      break _v31_4;
	                                                   } else {
	                                                      if (_p18._3._3.ctor === "RBNode_elm_builtin" &&
	                                                          _p18._3._3._0.ctor === "Black" && _p18._3._4.ctor ===
	                                                          "RBNode_elm_builtin" && _p18._3._4._0.ctor === "Black") {
	                                                         break _v31_5;
	                                                      } else {
	                                                         break _v31_6;
	                                                      }
	       ...
	       var rem = F3(function (c,l,r) {
	                    ...
	                    if (_p20._0.ctor === "RBEmpty_elm_builtin") {
	                       if (_p20._1.ctor === "RBEmpty_elm_builtin") {
	                          ...
	                          if (_p22.ctor === "_Tuple3" && _p22._0.ctor === "Black" &&
	                              _p22._1.ctor === "LBlack" && _p22._2.ctor === "Red") {
	                             return A5(RBNode_elm_builtin
	                                      ,Black
	                                      ,_p20._1._1
	                                      ,_p20._1._2
	                       ...
	                       if (_p20._1.ctor === "RBEmpty_elm_builtin") {
	                          ...
	                          if (_p25.ctor === "_Tuple3" && _p25._0.ctor === "Black" &&
	                              _p25._1.ctor === "Red" && _p25._2.ctor === "LBlack") {
	                             return A5(RBNode_elm_builtin
	                                      ,Black
	                                      ,_p20._0._1
	                                      ,_p20._0._2
	       ...
	       var update = F3(function (k,alter,dict) {
	                       var up = function (dict) {
	                          ...
	                          if (_p32.ctor === "RBEmpty_elm_builtin") {
	                             ...
	                             {
	                               case "EQ":
	                                 var _p35 = alter($Maybe.Just(_p44));
	       ...
	       var insert = F3(function (key,value,dict) {
	                       return A3(update,key,$Basics.always($Maybe.Just(value)),dict);
	                    });
	       ...
	       var filter = F2(function (predicate,dictionary) {
	                       var add = F3(function (key,value,dict) {
	                                    return A2(predicate,key,value) ? A3(insert,key,value,dict)
	                                        : dict;
	                                 });
	...
	Elm.Array.make = function (_elm) {
	       ...
	       var get = F2(function (i,array) {
	                    return _U.cmp(0,i) < 1 && _U.cmp(i,$Native$Array.length(array))
	                        < 0 ? $Maybe.Just(A2($Native$Array.get,i,array))
	                        : $Maybe.Nothing;
	                 });
	...
	Elm.Effects.make = function (_elm) {
	       ...
	       var toTaskHelp = F3(function (address,effect,_p0) {
	                           ...
	                           switch (_p2.ctor)
	                           {
	                             ...
	                             case "None":
	                               return _p4;
	                             default:
	                               return A3($List.foldl,toTaskHelp(address),_p4,_p2._0);
	                           }
	                        });
	       var toTask = F2(function (address,effect) {
	                       ...
	                       return $List.isEmpty(tickMessages) ? combinedTask
	                           : A2($Task.andThen
	                               ,combinedTask
	       ...
	       var map = F2(function (func,effect) {
	                    ...
	                    {
	                      case "Task":
	                        return Task(A2($Task.map,func,_p7._0));
	                      case "Tick":
	                        return Tick(function (_p8) {
	                               return func(_p7._0(_p8));
	                            });
	                      case "None":
	                        return None;
	                      default:
	                        return Batch(A2($List.map,map(func),_p7._0));
	                    }
	                 });
	...
	Elm.Markdown.make = function (_elm) {
	       ...
	       var toElement = function (string) {
	          return A2($Native$Markdown.toElementWith,defaultOptions,string);
	       };
	...
	Elm.Svg.Attributes.make = function (_elm) {
	       ...
	       var glyphOrientationVertical =
	       $VirtualDom.attribute("glyph-orientation-vertical");
	       var glyphOrientationHorizontal =
	       ...
	       var strikethroughThickness =
	       $VirtualDom.attribute("strikethrough-thickness");
	       var strikethroughPosition =
	       ...
	       var overlineThickness =
	       $VirtualDom.attribute("overline-thickness");
	       var overlinePosition =
	...
	Elm.Application.Style = Elm.Application.Style || {};
	Elm.Application.Style.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Style = _elm.Application.Style || {};
	       if (_elm.Application.Style.values)
	          return _elm.Application.Style.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $List = Elm.List.make(_elm),
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       return _elm.Application.Style.values = {_op: _op};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.Style = Elm.Application.Style || {};
	Elm.Application.Style.Flex = Elm.Application.Style.Flex || {};
	Elm.Application.Style.Flex.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Style = _elm.Application.Style || {};
	       _elm.Application.Style.Flex = _elm.Application.Style.Flex || {};
	       if (_elm.Application.Style.Flex.values)
	          return _elm.Application.Style.Flex.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style = Elm.Application.Style.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $List = Elm.List.make(_elm),
	       $Maybe = Elm.Maybe.make(_elm),
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       var flexStyle = function (flex) {
	          return _U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}
	                         ,function (_) {
	                            return _.justify;
	                         }(flex)
	                         ,function (_) {
	       ...
	       var alignItemsProp = function (position) {
	          var _p0 = position;
	          switch (_p0.ctor)
	          {
	            case "Start":
	       ...
	       var alignItemsStyle = function (position) {
	          return {ctor: "_Tuple2"
	                 ,_0: "align-items"
	                 ,_1: alignItemsProp(position)};
	       };
	       var justifyContentProp = function (position) {
	          var _p1 = position;
	          switch (_p1.ctor)
	          {
	            case "End":
	       ...
	       var justifyContentStyle = function (position) {
	          return {ctor: "_Tuple2"
	                 ,_0: "justify-content"
	                 ,_1: justifyContentProp(position)};
	       };
	       var wrapProp = function (wrap) {
	          var _p2 = wrap;
	          switch (_p2.ctor)
	          {
	            case "Wrap":
	       ...
	       var wrapStyle = function (wrap) {
	          return {ctor: "_Tuple2",_0: "flex-wrap",_1: wrapProp(wrap)};
	       };
	       var directionProp = function (direction) {
	          var _p3 = direction;
	          switch (_p3.ctor)
	          {
	            case "RowReverse":
	       ...
	       var directionStyle = function (direction) {
	          return {ctor: "_Tuple2"
	                 ,_0: "flex-direction"
	                 ,_1: directionProp(direction)};
	       };
	       var flowStyle = F2(function (direction,wrap) {
	                          return {ctor: "_Tuple2"
	                                 ,_0: "flex-flow"
	                                 ,_1: A2($Basics._op["++"]
	                                        ,directionProp(direction)
	                                        ,A2($Basics._op["++"]," ",wrapProp(wrap)))};
	                       });
	       var Flex = F3(function (a,b,c) {
	                     return {justify: a,align: b,flow: c};
	                  });
	       var Stretch = {ctor: "Stretch"};
	       var Baseline = {ctor: "Baseline"};
	       var Around = {ctor: "Around"};
	       ...
	       var flexColumn = {justify: justifyContentStyle(Center)
	                        ,align: alignItemsStyle(Start)
	                        ,flow: A2(flowStyle,Column,NoWrap)};
	       var RowReverse = {ctor: "RowReverse"};
	       var Row = {ctor: "Row"};
	       var flex = {justify: justifyContentStyle(Start)
	                  ,align: alignItemsStyle(Stretch)
	                  ,flow: A2(flowStyle,Row,NoWrap)};
	       var flexStart = {justify: justifyContentStyle(Center)
	                       ,align: alignItemsStyle(Start)
	                       ,flow: A2(flowStyle,Row,NoWrap)};
	       var flexCenter = {justify: justifyContentStyle(Center)
	                        ,align: alignItemsStyle(Center)
	                        ,flow: A2(flowStyle,Row,NoWrap)};
	       return _elm.Application.Style.Flex.values = {_op: _op
	                                                   ,flex: flex
	                                                   ,flexStart: flexStart
	...
	Elm.Application = Elm.Application || {};
	Elm.Application.Style = Elm.Application.Style || {};
	Elm.Application.Style.Color = Elm.Application.Style.Color || {};
	Elm.Application.Style.Color.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Style = _elm.Application.Style || {};
	       _elm.Application.Style.Color = _elm.Application.Style.Color ||
	           {};
	       if (_elm.Application.Style.Color.values)
	          return _elm.Application.Style.Color.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style = Elm.Application.Style.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       var bgc = function (rgba) {
	          return {ctor: "_Tuple2",_0: "background-color",_1: rgba};
	       };
	       var fc = function (rgba) {
	          return {ctor: "_Tuple2",_0: "color",_1: rgba};
	       };
	       var fcPc = fc("red");
	       var makeColor = function (alpha) {
	          return A2($Basics._op["++"]
	                   ,"rgba(0, 0, 0, "
	                   ,A2($Basics._op["++"],$Basics.toString(alpha),")"));
	       };
	       var grey1 = makeColor(0.16);
	       var fcG1 = fc(grey1);
	       var grey2 = makeColor(0.32);
	       var fcG2 = fc(grey2);
	       var grey3 = makeColor(0.56);
	       var fcG3 = fc(grey3);
	       var grey4 = makeColor(0.72);
	       var fcG4 = fc(grey4);
	       return _elm.Application.Style.Color.values = {_op: _op
	                                                    ,grey1: grey1
	                                                    ,grey2: grey2
	                                                    ,grey3: grey3
	                                                    ,grey4: grey4
	...
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Logo = Elm.Application.View.Home.Logo
	    || {};
	Elm.Application.View.Home.Logo.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Logo =
	           _elm.Application.View.Home.Logo || {};
	       if (_elm.Application.View.Home.Logo.values)
	          return _elm.Application.View.Home.Logo.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Color =
	       Elm.Application.Style.Color.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Html = Elm.Html.make(_elm),
	       ...
	       var _op = {};
	       var jColor =
	       $Html$Attributes.style(_U.list([$Application$Style$Color.fcPc]));
	       var logoStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                       ,_0: "font-size"
	                                                       ,_1: "4rem"}
	                                                      ,{ctor: "_Tuple2",_0: "font-weight",_1: "100"}
	                                                      ,{ctor: "_Tuple2",_0: "margin",_1: "0 1rem 0 0"}]));
	       var logoView = A2($Html.section
	                        ,_U.list([logoStyle])
	                        ,_U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("H")]))
	                                 ,A2($Html.span,_U.list([jColor]),_U.list([$Html.text("J")]))]));
	       return _elm.Application.View.Home.Logo.values = {_op: _op
	                                                       ,logoView: logoView};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Greet =
	    Elm.Application.View.Home.Greet || {};
	Elm.Application.View.Home.Greet.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Greet =
	           _elm.Application.View.Home.Greet || {};
	       if (_elm.Application.View.Home.Greet.values)
	          return _elm.Application.View.Home.Greet.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Color =
	       Elm.Application.Style.Color.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       ...
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                      ...
	                                      ,{ctor: "_Tuple2"
	                                       ,_0: "color"
	                                       ,_1: $Application$Style$Color.grey3}
	                                      ,{ctor: "_Tuple2",_0: "margin",_1: "0 0 0.5rem 0"}]));
	       var greetView = A2($Html.section
	                         ,_U.list([greetStyle])
	                         ,_U.list([$Html.text("Welcome")]));
	       return _elm.Application.View.Home.Greet.values = {_op: _op
	                                                        ,greetView: greetView};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Intro =
	    Elm.Application.View.Home.Intro || {};
	Elm.Application.View.Home.Intro.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Intro =
	           _elm.Application.View.Home.Intro || {};
	       if (_elm.Application.View.Home.Intro.values)
	          return _elm.Application.View.Home.Intro.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Color =
	       Elm.Application.Style.Color.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       ...
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                      ...
	                                      ,{ctor: "_Tuple2"
	                                       ,_0: "color"
	                                       ,_1: $Application$Style$Color.grey2}]));
	       var introView = A2($Html.section
	                         ,_U.list([introStyle])
	                         ,_U.list([$Html.text("Happy Hack with my life")]));
	       return _elm.Application.View.Home.Intro.values = {_op: _op
	                                                        ,introView: introView};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Header =
	    Elm.Application.View.Home.Header || {};
	Elm.Application.View.Home.Header.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Header =
	           _elm.Application.View.Home.Header || {};
	       if (_elm.Application.View.Home.Header.values)
	          return _elm.Application.View.Home.Header.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Flex = Elm.Application.Style.Flex.make(_elm),
	       $Application$View$Home$Greet =
	       Elm.Application.View.Home.Greet.make(_elm),
	       $Application$View$Home$Intro =
	       Elm.Application.View.Home.Intro.make(_elm),
	       $Application$View$Home$Logo =
	       Elm.Application.View.Home.Logo.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Html = Elm.Html.make(_elm),
	       $Html$Attributes = Elm.Html.Attributes.make(_elm),
	       ...
	       $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexColumn));
	       var headerLeftStyle =
	       $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter));
	       var headerStyle = $Html$Attributes.style(A2($Basics._op["++"]
	                                                  ,_U.list([{ctor: "_Tuple2",_0: "padding",_1: "0 0 20rem 0"}])
	                                                  ,$Application$Style$Flex.flexStyle($Application$Style$Flex.flex)));
	       var headerView = A2($Html.header
	                          ,_U.list([headerStyle])
	                          ,_U.list([A2($Html.section
	                                      ,_U.list([headerLeftStyle])
	                                      ,_U.list([$Application$View$Home$Logo.logoView]))
	                                   ,A2($Html.section
	                                      ,_U.list([headerRightStyle])
	                                      ,_U.list([$Application$View$Home$Greet.greetView
	                                               ,$Application$View$Home$Intro.introView]))]));
	       return _elm.Application.View.Home.Header.values = {_op: _op
	                                                         ,headerView: headerView};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Hello =
	    Elm.Application.View.Home.Hello || {};
	Elm.Application.View.Home.Hello.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Hello =
	           _elm.Application.View.Home.Hello || {};
	       if (_elm.Application.View.Home.Hello.values)
	          return _elm.Application.View.Home.Hello.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Flex = Elm.Application.Style.Flex.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       ...
	       var imagePath = "./Image/Just-me.jpg";
	       var helloStyle =
	       $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter));
	       var helloView = A2($Html.section
	                         ,_U.list([helloStyle])
	                         ,_U.list([A2($Html.img
	                                     ,_U.list([imageStyle,$Html$Attributes.src(imagePath)])
	                                     ,_U.list([]))]));
	       return _elm.Application.View.Home.Hello.values = {_op: _op
	                                                        ,helloView: helloView};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.Sitemap = Elm.Application.Sitemap || {};
	Elm.Application.Sitemap.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Sitemap = _elm.Application.Sitemap || {};
	       if (_elm.Application.Sitemap.values)
	          return _elm.Application.Sitemap.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $List = Elm.List.make(_elm),
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       var PostsR = function (a) { return {ctor: "PostsR",_0: a};};
	       var AboutR = function (a) { return {ctor: "AboutR",_0: a};};
	       var HomeR = function (a) { return {ctor: "HomeR",_0: a};};
	       return _elm.Application.Sitemap.values = {_op: _op
	                                                ,HomeR: HomeR
	                                                ,AboutR: AboutR
	                                                ,PostsR: PostsR};
	    };
	...
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Nav = Elm.Application.View.Home.Nav ||
	    {};
	Elm.Application.View.Home.Nav.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Home = _elm.Application.View.Home || {};
	       _elm.Application.View.Home.Nav = _elm.Application.View.Home.Nav
	           || {};
	       if (_elm.Application.View.Home.Nav.values)
	          return _elm.Application.View.Home.Nav.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Color =
	       Elm.Application.Style.Color.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       ...
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                       ,_0: "margin"
	                                       ,_1: "0.5rem 0"}
	                                      ,{ctor: "_Tuple2",_0: "font-size",_1: "1.4rem"}
	                                      ,{ctor: "_Tuple2",_0: "font-weight",_1: "100"}
	                                      ,$Application$Style$Color.fcG3]));
	       var navigateStyle =
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                       ,_0: "position"
	                                       ,_1: "absolute"}
	                                      ,{ctor: "_Tuple2",_0: "bottom",_1: "20%"}
	                                      ,{ctor: "_Tuple2",_0: "right",_1: "50%"}]));
	       var listItemView = function (linker) {
	          return A2($Html.li,_U.list([listItemStyle]),_U.list([linker]));
	       };
	       var linkerView = F2(function (str,$char) {
	                           var dom = function (c) {
	                              return _U.eq(c,$char) ? A2($Html.span
	                                                        ,_U.list([redColor])
	                                                        ,_U.list([$Html.text($String.toUpper(c))])) : A2($Html.span
	                                                                                                        ,_U.list([])
	                                                                                                        ,_U.list([$Html.text(c)]));
	                           };
	                           return A2($List.map,dom,A2($String.split,"",str));
	                        });
	       var view = F2(function (link1,link2) {
	                     return A2($Html.nav
	                              ,_U.list([navigateStyle])
	                              ,_U.list([A2($Html.ul
	                                          ,_U.list([$Html$Attributes.$class("listReset")])
	                                          ,_U.list([listItemView(link1(A2(linkerView,"Note on","e")))
	                                                   ,listItemView(link2(A2(linkerView,"Find me","d")))]))]));
	                  });
	       return _elm.Application.View.Home.Nav.values = {_op: _op
	                                                      ,view: view};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Rect = Elm.Application.View.Rect || {};
	Elm.Application.View.Rect.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.View = _elm.Application.View || {};
	       _elm.Application.View.Rect = _elm.Application.View.Rect || {};
	       if (_elm.Application.View.Rect.values)
	          return _elm.Application.View.Rect.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Html = Elm.Html.make(_elm),
	       ...
	       var _op = {};
	       var rectStyle = F3(function (x,y,deg) {
	                          return $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                                 ,_0: "position"
	                                                                 ,_1: "absolute"}
	                                                                ,{ctor: "_Tuple2",_0: "top",_1: x}
	                                                                ,{ctor: "_Tuple2",_0: "left",_1: y}
	                                                                ,{ctor: "_Tuple2"
	                                                                 ,_0: "transform"
	                                                                 ,_1: A2($Basics._op["++"]
	                                                                        ,"rotate("
	                                                                        ,A2($Basics._op["++"],$Basics.toString(deg),"deg)"))}]));
	                       });
	       var rectLeftTopStyle = A3(rectStyle,"0","0",0);
	       var rectView = A2($Svg.svg
	                        ,_U.list([$Svg$Attributes.width("30")
	                                 ,$Svg$Attributes.height("40")
	                                 ,$Svg$Attributes.viewBox("0 0 30 40")])
	                        ,_U.list([A2($Svg.rect
	                                    ,_U.list([$Svg$Attributes.x("0")
	                                             ,$Svg$Attributes.y("0")
	                                             ,$Svg$Attributes.width("30")
	                                             ,$Svg$Attributes.height("40")
	                                             ,$Svg$Attributes.opacity("0.16")])
	                                    ,_U.list([]))]));
	       var rectGroupView1 = F3(function (x,y,deg) {
	                               return A2($Html.section
	                                        ,_U.list([A3(rectStyle,x,y,0)])
	                                        ,_U.list([A2($Html.section
	       ...
	       return _elm.Application.View.Rect.values = {_op: _op
	                                                  ,rectView: rectView
	                                                  ,rectGroupView1: rectGroupView1
	                                                  ,rectStyle: rectStyle
	                                                  ,rectLeftTopStyle: rectLeftTopStyle};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.Home = Elm.Application.Home || {};
	Elm.Application.Home.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Home = _elm.Application.Home || {};
	       if (_elm.Application.Home.values)
	          return _elm.Application.Home.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Style$Flex = Elm.Application.Style.Flex.make(_elm),
	       $Application$View$Home$Header =
	       Elm.Application.View.Home.Header.make(_elm),
	       $Application$View$Home$Hello =
	       Elm.Application.View.Home.Hello.make(_elm),
	       $Application$View$Home$Nav =
	       Elm.Application.View.Home.Nav.make(_elm),
	       $Application$View$Rect = Elm.Application.View.Rect.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Effects = Elm.Effects.make(_elm),
	       $Html = Elm.Html.make(_elm),
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       var newsStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                       ,_0: "width"
	                                                       ,_1: "80%"}
	                                                      ,{ctor: "_Tuple2",_0: "height",_1: "40%"}]));
	       var mainRightStyle = $Html$Attributes.style(A2($Basics._op["++"]
	                                                     ,_U.list([{ctor: "_Tuple2",_0: "position",_1: "relative"}
	                                                              ,{ctor: "_Tuple2",_0: "flex",_1: "1 0 50%"}])
	                                                     ,$Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter)));
	       var mainLeftStyle = $Html$Attributes.style(A2($Basics._op["++"]
	                                                    ,_U.list([{ctor: "_Tuple2",_0: "position",_1: "relative"}
	                                                             ,{ctor: "_Tuple2",_0: "flex",_1: "1 0 50%"}])
	                                                    ,$Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter)));
	       var mainStyle = $Html$Attributes.style(A2($Basics._op["++"]
	                                                ,_U.list([{ctor: "_Tuple2",_0: "width",_1: "64rem"}
	                                                         ,{ctor: "_Tuple2",_0: "height",_1: "40rem"}
	                                                         ,{ctor: "_Tuple2",_0: "position",_1: "relative"}])
	                                                ,$Application$Style$Flex.flexStyle($Application$Style$Flex.flex)));
	       var update = F2(function (action,model) {
	                       return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
	                    });
	       var init = {ctor: "_Tuple2",_0: 0,_1: $Effects.none};
	       var note = {title: "爱上 Processing"
	                  ,date: "Mar 20th, 2016"
	                  ,intro: "Processing？ 喜欢好久了但一直没时间入，今天终于有时间看了一个通宵。还是挺喜欢的，拿他攻打GUI这个BOSS我想应该木问题。"
	                  ,intro2: "那么首先，什么是Processing？"};
	       var topNoteView = function (note) {
	          return _U.list([A2($Html.h1
	                            ,_U.list([])
	                            ,_U.list([$Html.text(function (_) {
	                               return _.title;
	                            }(note))]))
	                         ,A2($Html.p
	       ...
	       var view = F2(function (link1,link2) {
	                     return A2($Html.main$
	                              ,_U.list([mainStyle])
	                              ,_U.list([A2($Html.section
	                                          ,_U.list([mainLeftStyle])
	                                          ,_U.list([A2($Html.section
	                                                      ,_U.list([newsStyle,$Html$Attributes.$class("md")])
	                                                      ,topNoteView(note))
	                                                   ,A3($Application$View$Rect.rectGroupView1,"70%","80%",0)
	                                                   ,A3($Application$View$Rect.rectGroupView1,"10%","0%",45)]))
	                                       ,A2($Html.section
	                                          ,_U.list([mainRightStyle])
	                                          ,_U.list([$Application$View$Home$Header.headerView
	                                                   ,A2($Application$View$Home$Nav.view,link1,link2)
	                                                   ,$Application$View$Home$Hello.helloView]))]));
	                  });
	       var TopNote = F4(function (a,b,c,d) {
	                        return {title: a,date: b,intro: c,intro2: d};
	                     });
	       return _elm.Application.Home.values = {_op: _op
	                                             ,init: init
	                                             ,update: update
	                                             ,view: view};
	    };
	Elm.Application = Elm.Application || {};
	Elm.Application.Page = Elm.Application.Page || {};
	Elm.Application.Page.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Page = _elm.Application.Page || {};
	       if (_elm.Application.Page.values)
	          return _elm.Application.Page.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $List = Elm.List.make(_elm),
	       ...
	       var Home = {ctor: "Home"};
	       return _elm.Application.Page.values = {_op: _op
	                                             ,Home: Home
	                                             ,About: About
	                                             ,Posts: Posts
	                                             ,NotFound: NotFound};
	...
	Elm.Application = Elm.Application || {};
	Elm.Application.Router = Elm.Application.Router || {};
	Elm.Application.Router.make = function (_elm) {
	       "use strict";
	       _elm.Application = _elm.Application || {};
	       _elm.Application.Router = _elm.Application.Router || {};
	       if (_elm.Application.Router.values)
	          return _elm.Application.Router.values;
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Home = Elm.Application.Home.make(_elm),
	       $Application$Page = Elm.Application.Page.make(_elm),
	       $Application$Sitemap = Elm.Application.Sitemap.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Effects = Elm.Effects.make(_elm),
	       ...
	       $Task = Elm.Task.make(_elm);
	       var _op = {};
	       var about = $Html.text("施工中...");
	       var posts = $Html.text("施工中...");
	       var home = $Html.text("Home page");
	       var notFound = $Html.text("Page not found");
	       var routeToPath = function (route) {
	          var _p0 = route;
	          switch (_p0.ctor)
	          {
	            case "HomeR":
	              return $Application$Page.Home;
	            case "AboutR":
	              return $Application$Page.About;
	            default:
	              return $Application$Page.Posts;
	          }
	       };
	       ...
	       var view = F2(function (address,model) {
	                     var link = function (route) {
	                        return $Html.a(_U.list([A2($Html$Events.onClick
	                                                  ,address
	                                                  ,UpdatePath(route))]));
	                     };
	                     var postsLink =
	                     link($Application$Sitemap.PostsR({ctor: "_Tuple0"}));
	                     var aboutLink =
	                     link($Application$Sitemap.AboutR({ctor: "_Tuple0"}));
	                     return A2($Html.div
	                              ,_U.list([])
	                              ,_U.list([function () {
	                                 var _p1 = model.page;
	                                 ...
	                                 {
	                                   case "Home":
	                                     return A2($Application$Home.view,postsLink,aboutLink);
	                                   case "About":
	                                     return about;
	                                   case "Posts":
	                                     return posts;
	       ...
	       var NoOp = {ctor: "NoOp"};
	       var Model = function (a) { return {page: a};};
	       var postsR = A2($Route._op[":="]
	                      ,$Application$Sitemap.PostsR
	                      ,$Route.$static("posts"));
	       var aboutR = A2($Route._op[":="]
	                      ,$Application$Sitemap.AboutR
	                      ,$Route.$static("about"));
	       var homeR = A2($Route._op[":="]
	                     ,$Application$Sitemap.HomeR
	                     ,$Route.$static(""));
	       var sitemap = $Route.router(_U.list([homeR,aboutR,postsR]));
	       var match = $Route.match(sitemap);
	       var pathToPage = function (path) {
	          var _p2 = match(path);
	          if (_p2.ctor === "Nothing") {
	             return $Application$Page.NotFound;
	          } else {
	             return routeToPath(_p2._0);
	          }
	       };
	       var init = function (path) {
	          return {ctor: "_Tuple2"
	                 ,_0: {page: pathToPage(path)}
	                 ,_1: $Effects.none};
	       };
	       var route = function (route) {
	          ...
	          {
	            case "HomeR":
	              return A2($Route.reverse,homeR,_U.list([]));
	            case "AboutR":
	              return A2($Route.reverse,aboutR,_U.list([]));
	            default:
	              return A2($Route.reverse,postsR,_U.list([]));
	          }
	       };
	       var update = F2(function (action,model) {
	                       var _p4 = action;
	                       switch (_p4.ctor)
	                       {
	                         ...
	                         case "PathChange":
	                           return {ctor: "_Tuple2"
	                                  ,_0: {page: pathToPage(_p4._0)}
	                                  ,_1: $Effects.none};
	                         default:
	                           return {ctor: "_Tuple2"
	                                  ,_0: model
	                                  ,_1: $Effects.task(A2($Task.map
	                                                       ,$Basics.always(NoOp)
	                                                       ,$Task.toMaybe($History.setPath(route(_p4._0)))))};
	                       }
	                    });
	       return _elm.Application.Router.values = {_op: _op
	                                               ,homeR: homeR
	                                               ,aboutR: aboutR
	                                               ,postsR: postsR
	                                               ,sitemap: sitemap
	...
	Elm.Main.make = function (_elm) {
	       ...
	       var _U = Elm.Native.Utils.make(_elm),
	       $Application$Router = Elm.Application.Router.make(_elm),
	       $Basics = Elm.Basics.make(_elm),
	       $Debug = Elm.Debug.make(_elm),
	       $Effects = Elm.Effects.make(_elm),
	       $History = Elm.History.make(_elm),
	       ...
	       $Task = Elm.Task.make(_elm);
	       var _op = {};
	       var path = Elm.Native.Port.make(_elm).inbound("path"
	                                                    ,"String"
	                                                    ,function (v) {
	                                                       return typeof v === "string" || typeof v === "object" && v
	                                                           instanceof String ? v : _U.badPort("a string",v);
	                                                    });
	       var app = $StartApp.start({init: $Application$Router.init(path)
	                                 ,update: $Application$Router.update
	                                 ,view: $Application$Router.view
	                                 ,inputs: _U.list([A2($Signal.map
	                                                     ,$Application$Router.PathChange
	                                                     ,$History.path)])});
	       var main = app.html;
