...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;var require;var require;/* WEBPACK VAR INJECTION */(function(global) {var Elm = Elm || { Native: {} };
	Elm.Native.Basics = {};
	            ...
	            _v2_7: do {
	               if (_p4.ctor === "_Tuple2") {
	                     if (_p4._1.ctor === "[]") {
	                           ...
	                           {case "CPrefix": var _v3 = A2($List._op["::"],_p4._1._0._0,cs),
	                                _v4 = is,
	                                _v5 = _p4._1._1;
	                                cs = _v3;
	                                is = _v4;
	                                xs = _v5;
	                                continue accumulate;
	                              case "CSuffix": var _v6 = A2($List._op["::"],_p4._1._0._0,cs),
	                                _v7 = is,
	                                _v8 = _p4._1._1;
	                                cs = _v6;
	                                is = _v7;
	...
	Elm.Application.View.Home.Logo.make = function (_elm) {
	   ...
	   _elm.Application.View.Home.Logo = _elm.Application.View.Home.Logo || {};
	   if (_elm.Application.View.Home.Logo.values)
	   return _elm.Application.View.Home.Logo.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Application$Style$Color = Elm.Application.Style.Color.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $Html = Elm.Html.make(_elm),
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var jColor = $Html$Attributes.style(_U.list([$Application$Style$Color.fcPc]));
	...
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Greet = Elm.Application.View.Home.Greet || {};
	Elm.Application.View.Home.Greet.make = function (_elm) {
	   "use strict";
	   _elm.Application = _elm.Application || {};
	   _elm.Application.View = _elm.Application.View || {};
	   _elm.Application.View.Home = _elm.Application.View.Home || {};
	   _elm.Application.View.Home.Greet = _elm.Application.View.Home.Greet || {};
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var greetStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                    ,_0: "font-size"
	                                                    ,_1: "1.2rem"}
	                                                   ,{ctor: "_Tuple2"
	                                                    ,_0: "color"
	...
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Intro = Elm.Application.View.Home.Intro || {};
	Elm.Application.View.Home.Intro.make = function (_elm) {
	   "use strict";
	   _elm.Application = _elm.Application || {};
	   _elm.Application.View = _elm.Application.View || {};
	   _elm.Application.View.Home = _elm.Application.View.Home || {};
	   _elm.Application.View.Home.Intro = _elm.Application.View.Home.Intro || {};
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var introStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                    ,_0: "font-size"
	                                                    ,_1: "0.8rem"}
	                                                   ,{ctor: "_Tuple2"
	                                                    ,_0: "color"
	...
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Header = Elm.Application.View.Home.Header || {};
	Elm.Application.View.Home.Header.make = function (_elm) {
	   "use strict";
	   _elm.Application = _elm.Application || {};
	   _elm.Application.View = _elm.Application.View || {};
	   _elm.Application.View.Home = _elm.Application.View.Home || {};
	   _elm.Application.View.Home.Header = _elm.Application.View.Home.Header || {};
	   ...
	   $Application$View$Home$Greet = Elm.Application.View.Home.Greet.make(_elm),
	   $Application$View$Home$Intro = Elm.Application.View.Home.Intro.make(_elm),
	   $Application$View$Home$Logo = Elm.Application.View.Home.Logo.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $Html = Elm.Html.make(_elm),
	   $Html$Attributes = Elm.Html.Attributes.make(_elm),
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var headerRightStyle = $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexColumn));
	   var headerLeftStyle = $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter));
	...
	Elm.Application.View = Elm.Application.View || {};
	Elm.Application.View.Home = Elm.Application.View.Home || {};
	Elm.Application.View.Home.Hello = Elm.Application.View.Home.Hello || {};
	Elm.Application.View.Home.Hello.make = function (_elm) {
	   "use strict";
	   _elm.Application = _elm.Application || {};
	   _elm.Application.View = _elm.Application.View || {};
	   _elm.Application.View.Home = _elm.Application.View.Home || {};
	   _elm.Application.View.Home.Hello = _elm.Application.View.Home.Hello || {};
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var imageStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                    ,_0: "width"
	                                                    ,_1: "60%"}
	                                                   ,{ctor: "_Tuple2",_0: "height",_1: "auto"}]));
	   var imagePath = "./Image/Just-me.jpg";
	   var helloStyle = $Html$Attributes.style($Application$Style$Flex.flexStyle($Application$Style$Flex.flexCenter));
	...
	Elm.Application.View.Home.Nav.make = function (_elm) {
	   ...
	   var _op = {};
	   var jColor = $Html$Attributes.style(_U.list([$Application$Style$Color.fcPc]));
	   var menuItemStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                       ,_0: "font-size"
	                                                       ,_1: "1.4rem"}
	                                                      ,$Application$Style$Color.fcG3
	                                                      ,{ctor: "_Tuple2",_0: "font-weight",_1: "100"}
	                                                      ,{ctor: "_Tuple2",_0: "margin",_1: "0.5rem 0"}]));
	   var menuStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                   ,_0: "list-style-type"
	                                                   ,_1: "none"}
	                                                  ,{ctor: "_Tuple2",_0: "padding",_1: "0"}
	                                                  ,{ctor: "_Tuple2",_0: "margin",_1: "0"}]));
	   var navigateStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                       ,_0: "position"
	                                                       ,_1: "absolute"}
	                                                      ,{ctor: "_Tuple2",_0: "bottom",_1: "20%"}
	                                                      ,{ctor: "_Tuple2",_0: "right",_1: "50%"}]));
	   var navView = A2($Html.nav,
	   _U.list([navigateStyle]),
	   _U.list([A2($Html.ul,
	   _U.list([menuStyle]),
	   _U.list([A2($Html.li,
	           _U.list([menuItemStyle]),
	           _U.list([A2($Html.a,
	           _U.list([]),
	           _U.list([$Html.text("Not")
	                   ,A2($Html.span,_U.list([jColor]),_U.list([$Html.text("E")]))
	                   ,$Html.text(" on")]))]))
	           ,A2($Html.li,
	           _U.list([menuItemStyle]),
	           _U.list([A2($Html.a,
	           _U.list([$Html$Attributes.href("/about")]),
	           _U.list([$Html.text("Fin")
	                   ,A2($Html.span,_U.list([jColor]),_U.list([$Html.text("D")]))
	                   ,$Html.text(" me")]))]))]))]));
	...
	Elm.Application.Home.make = function (_elm) {
	   ...
	   var _U = Elm.Native.Utils.make(_elm),
	   $Application$Style$Flex = Elm.Application.Style.Flex.make(_elm),
	   $Application$View$Home$Header = Elm.Application.View.Home.Header.make(_elm),
	   $Application$View$Home$Hello = Elm.Application.View.Home.Hello.make(_elm),
	   $Application$View$Home$Nav = Elm.Application.View.Home.Nav.make(_elm),
	   ...
	   var topNoteView = function (note) {
	      return _U.list([A2($Html.h1,
	                     _U.list([]),
	                     _U.list([$Html.text(function (_) {    return _.title;}(note))]))
	                     ,A2($Html.p,
	                     _U.list([$Html$Attributes.$class("date")]),
	                     _U.list([$Html.text(function (_) {    return _.date;}(note))]))
	                     ,A2($Html.p,
	                     _U.list([]),
	                     _U.list([$Html.text(function (_) {    return _.intro;}(note))]))
	                     ,A2($Html.p,
	                     _U.list([]),
	   ...
	   _U.list([A2($Html.section,
	           ...
	           _U.list([$Application$View$Home$Header.headerView
	                   ,$Application$View$Home$Nav.navView
	...
	Elm.Application.Router.make = function (_elm) {
	   ...
	   $Task = Elm.Task.make(_elm);
	   var _op = {};
	   var about = $Html.text("About Page");
	   ...
	   var view = F2(function (address,model) {
	      var link = F2(function (route,content) {
	         return A2($Html.a,
	         _U.list([A2($Html$Events.onClick,address,UpdatePath(route))]),
	      ...
	      _U.list([function () {
	         var _p0 = model.page;
	         switch (_p0.ctor)
	         {case "Home": return $Application$Home.view;
	   ...
	   var homeR = A2($Route._op[":="],HomeR,$Route.$static(""));
	   var sitemap = $Route.router(_U.list([homeR,aboutR]));
	   ...
	   var update = F2(function (action,model) {
	      ...
	      {case "NoOp": return {ctor: "_Tuple2"
	                           ,_0: model
	                           ,_1: $Effects.none};
	         case "PathChange": return {ctor: "_Tuple2"
