...
/***/ function(module, exports, __webpack_require__) {
	...
	Elm.Application.View.Home.Logo.make = function (_elm) {
	       ...
	       $Signal = Elm.Signal.make(_elm);
	       var _op = {};
	       var jColor = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                    ,_0: "color"
	                                                    ,_1: "red"}]));
	...
	Elm.Application.View.Home.Greet.make = function (_elm) {
	       ...
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                      ...
	                                      ,{ctor: "_Tuple2"
	                                       ,_0: "color"
	                                       ,_1: $Application$Style$Color.grey4}
	...
	Elm.Application.Home.make = function (_elm) {
	       ...
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                       ,_0: "color"
	                                       ,_1: $Application$Style$Color.grey3}
	                                      ,{ctor: "_Tuple2",_0: "margin",_1: "0 0 1rem 0"}]));
	       var dateStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                       ,_0: "color"
	                                                       ,_1: $Application$Style$Color.grey2}
	                                                      ,{ctor: "_Tuple2",_0: "font-size",_1: "0.8rem"}
	                                                      ,{ctor: "_Tuple2",_0: "margin",_1: "-0.5rem 0 2rem 0"}]));
	       var noticeStyle =
	       $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                       ,_0: "font-size"
	                                       ,_1: "1.5rem"}
	                     ...
	                     return A2($Html.main$
	                              ...
	                              ,_U.list([A2($Html.section
	                                          ...
	                                          ,_U.list([A2($Html.section
	                                                      ...
	                                                      ,_U.list([A2($Html.h1
	                                                                  ,_U.list([noticeStyle])
	                                                                  ,_U.list([$Html.text("爱上 Processing")]))
	                                                               ,A2($Html.p
	                                                                  ,_U.list([dateStyle])
	                                                                  ,_U.list([$Html.text("Mar 20th. 2016")]))
	                                                               ,A2($Html.p
	                                                                  ,_U.list([introStyle])
	                                                                  ,_U.list([$Html.text("Processing？ 喜欢好久了但一直没时间入，今天终于有时间看了一个通宵。还是挺喜欢的，拿他攻打GUI这个BOSS我想应该木问题。")]))
	                                                               ,A2($Html.p
	                                                                  ,_U.list([introStyle])
	                                                                  ,_U.list([$Html.text("那么首先，什么是Processing？")]))
	                                                               ,A2($Html.p
	                                                                  ,_U.list([introStyle])
	                                                                  ,_U.list([$Html.text("...")]))]))
	                                                   ,A3($Application$View$Rect.rectGroupView1,"70%","70%",0)
	...
	Elm.Main.make = function (_elm) {
	       ...
	       $Task = Elm.Task.make(_elm);
	       var _op = {};
	       var app = $StartApp.start({init: $Application$Home.init
	                                 ,update: $Application$Home.update
	                                 ,view: $Application$Home.view
	                                 ,inputs: _U.list([])});
	       var main = app.html;
